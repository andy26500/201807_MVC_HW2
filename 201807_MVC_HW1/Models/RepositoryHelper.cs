namespace _201807_MVC_HW1.Models
{
	public static class RepositoryHelper
	{
		...
		public static 客戶統計資訊Repository Get客戶統計資訊Repository()
		{
			var repository = new 客戶統計資訊Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 客戶統計資訊Repository Get客戶統計資訊Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 客戶統計資訊Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
